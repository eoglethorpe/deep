...
class SurveyOfSurvey(models.Model):
    ...
    start_data_collection = models.ManyToManyField(DataCollectionTechnique, blank=True, related_name="start_data_collections")
    end_data_collection = models.ManyToManyField(DataCollectionTechnique, blank=True, related_name="end_data_collections")
