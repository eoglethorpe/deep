...
var childrenFields = {
    ...
    addChildElement: function(parentDiv, setValues) {
        ...
        var childElement = $('<div class="human-profile-child"><i></i><input class="human-profile-child-number number"><div class="human-profile-child-source source-new"></div><input class="human-profile-child-comment"><a class="fa fa-minus remove-child"></a></div>');
