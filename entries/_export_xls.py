...
def _gen_base_vals():
    ...
    return OrderedDict([
            ...
            ('Admin Level 1 - P Code', 'get_pcode_lvl1'),
            # ('Admin Level 2', 'get_admn_lvl2'),
            ('Admin Level 2 - P Code', 'get_pcode_lvl2'),
            # ('Admin Level 3', 'get_admn_lvl3'),
            ('Admin Level 3 - P Code', 'get_pcode_lvl3'),
            # ('Admin Level 4', 'get_admn_lvl4'),
            ('Admin Level 4 - P Code', 'get_pcode_lvl4'),
            # ('Admin Level 5', 'get_admn_lvl5'),
            ('Admin Level 5 - P Code', 'get_pcode_lvl5'),
