...
def get_pcode_lvl1(e):
    return [v.pcode for v in e.map_selections.all() if v.admin_level.level == 1]

def get_pcode_lvl2(e):
    return [v.pcode for v in e.map_selections.all() if v.admin_level.level == 2]

def get_pcode_lvl3(e):
    return [v.pcode for v in e.map_selections.all() if v.admin_level.level == 3]

def get_pcode_lvl4(e):
    return [v.pcode for v in e.map_selections.all() if v.admin_level.level == 4]

def get_pcode_lvl5(e):
    return [v.pcode for v in e.map_selections.all() if v.admin_level.level == 5]
